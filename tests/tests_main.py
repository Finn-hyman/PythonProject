...
class TestMain(unittest.TestCase):
    ...
    @patch('builtins.input', side_effect=['1', 'Lunch', '10.0', '1', '8'])
    ...
    def test_main_menu_add_expense(self, mock_add, mock_input) -> None:
        ...
        main_menu()
        mock_add.assert_called_once() # Ensure add_expense was called

    @patch('builtins.input', side_effect=['2', '1', '8'])
    ...
    @patch('builtins.input', side_effect=['1', 'Dinner', '15', '2', '8'])
    @patch('main.database.add_expense')
